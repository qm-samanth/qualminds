...
const Hero: React.FC = () => {
  return (
    <>
      ...
      >
        <div className="w-full max-w-7xl px-2 md:px-8 text-center grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8 justify-center items-stretch -mt-12 md:-mt-28 animate-fade-in-up">
          <a href="/digital-product-engineering" className="w-full max-w-lg lg:max-w-xl mx-auto bg-white/90 rounded-3xl shadow-strong overflow-hidden flex flex-col items-center justify-center p-8 md:p-10 group transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl hover:-translate-y-2 cursor-pointer relative z-20 border-2 border-[#e0c3fc]/60 hover:border-[#6610f2] backdrop-blur-xs animate-fade-in-up" style={{ background: 'linear-gradient(135deg, #f3e7e9 0%, #e3eeff 100%)', animationDelay: '0.1s', animationFillMode: 'both' }}>
          ...
          <a href="#contact" className="w-full max-w-lg lg:max-w-xl mx-auto bg-white/90 rounded-3xl shadow-strong overflow-hidden flex flex-col items-center justify-center p-8 md:p-10 group transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl hover:-translate-y-2 cursor-pointer relative z-20 border-2 border-[#e0c3fc]/60 hover:border-[#6610f2] backdrop-blur-xs animate-fade-in-up" style={{ background: 'linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)', animationDelay: '0.2s', animationFillMode: 'both' }}>
            <div className="flex flex-col items-center justify-center mb-4 animate-fade-in">
          ...
          <a href="#contact" className="w-full max-w-lg lg:max-w-xl mx-auto bg-white/90 rounded-3xl shadow-strong overflow-hidden flex flex-col items-center justify-center p-8 md:p-10 group transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl hover:-translate-y-2 cursor-pointer relative z-20 border-2 border-[#e0c3fc]/60 hover:border-[#6610f2] backdrop-blur-xs animate-fade-in-up" style={{ background: 'linear-gradient(135deg, #f3e7e9 0%, #e3eeff 100%)', animationDelay: '0.3s', animationFillMode: 'both' }}>
            <div className="flex flex-col items-center justify-center mb-4 animate-fade-in">
          ...
          <a href="#contact" className="w-full max-w-lg lg:max-w-xl mx-auto bg-white/90 rounded-3xl shadow-strong overflow-hidden flex flex-col items-center justify-center p-8 md:p-10 group transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl hover:-translate-y-2 cursor-pointer relative z-20 border-2 border-[#e0c3fc]/60 hover:border-[#6610f2] backdrop-blur-xs animate-fade-in-up" style={{ background: 'linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)', animationDelay: '0.4s', animationFillMode: 'both' }}>
            <div className="flex flex-col items-center justify-center mb-4 animate-fade-in">
              {/* DevOps Icon */}
          ...
          <a href="#contact" className="w-full max-w-lg lg:max-w-xl mx-auto bg-white/90 rounded-3xl shadow-strong overflow-hidden flex flex-col items-center justify-center p-8 md:p-10 group transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl hover:-translate-y-2 cursor-pointer relative z-20 border-2 border-[#e0c3fc]/60 hover:border-[#6610f2] backdrop-blur-xs animate-fade-in-up" style={{ background: 'linear-gradient(135deg, #f3e7e9 0%, #e3eeff 100%)', animationDelay: '0.5s', animationFillMode: 'both' }}>
            <div className="flex flex-col items-center justify-center mb-4 animate-fade-in">
              {/* Mobility & IoT Icon */}
